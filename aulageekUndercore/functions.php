...
if ( ! function_exists( 'aulageek_setup' ) ) :
	...
	function aulageek_setup() {
		 ...
		 */
		load_theme_textdomain( 'aulageek', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'aulageek' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'aulageek_custom_background_args', array(
...
function aulageek_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'aulageek_content_width', 640 );
}
 ...
 */
function aulageek_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'aulageek' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'aulageek' ),
...
add_action( 'widgets_init', 'aulageek_widgets_init' );
